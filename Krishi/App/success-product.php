...
if(isset($_GET['store_id']) && isset($_GET['id'])){
...
<body>
  <div class="bg-white shadow-sm p-3">
    <div class="d-flex align-items-center">
      <div class="gap-3 d-flex align-items-center">
        ...
        <h3 class="fw-bold m-0">Success</h3>
      </div>
  ...
  <div class="my-5">
    <div class="text-center">
      ...
      <div class="h1 text-success mb-1">Your product <br>added successfully!</div>
      
    </div>
  </div>

  <div class="d-grid fixed-bottom gap-2 p-3">
    <a href="product-detail?id=<?=$_GET['id'];?>" class="btn krishisampark-btn text-white btn-lg">View product</a>
    <a href="add-products?store_id=<?=$_GET['store_id'];?>" class="btn krishisampark-bg btn-lg  text-white">Add More</a>
  </div>
