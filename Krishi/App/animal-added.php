...
<head>
  ...
  <title>Krishisampark : Buy, Sell Your Animals</title>
...
<body>
  ...
  <div class="my-5">
    <div class="text-center">
      ...
      <div class="h1 text-success mb-1">Your animal details added successfully!</div>
      
    </div>
  </div>

  <div class="d-grid fixed-bottom gap-2 p-3">
    <a href="listing-detail?id=<?=$_GET['id'];?>" class="btn krishisampark-btn text-white btn-lg">View</a>
    <a href="add-animal" class="btn krishisampark-bg btn-lg  text-white">Add More</a>
  </div>
