...
$userAds = userServices($con,$userData->userId);
?>
  ...
  <div class="bg-white shadow-sm p-3">
    <div class="d-flex align-items-center">
      <div class="gap-3 d-flex align-items-center">
        ...
        <h3 class="fw-bold m-0">My Services</h3>
      </div>
...
?>
      ...
      <div class="row gy-3">
            ...
            <div class="card rounded-4 shadow border-0 overflow-hidden">
              <div class="position-relative">
                ...
                <div class="product-rating shadow-sm">
                  <a href="add-products?store_id=<?=$ad->id;?>" class='btn btn-success'>
                        <i class="fa fa-add"></i>
                    </a>
        ...
        <?php } }else{ echo "<h2>No service found</h2>"; } ?>
    ...
    $('.delete-button').on('click', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var deleteUrl = 'delete?ad_id=' + adId +'&type=Service'; // Replace with your delete URL
