...
$category = getCatName($con,$_GET['slug']);

$ads = getBusinessByCatAll($con,$_GET['slug']);
if($ads==2){
            ...
            <div class="col-lg-6 col-md-6">
                <div class="breadcrumb-area">
                    <ul>
                        ...
                        <li><span>/</span><?=$category;?> Listings</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            if ($timeDifference->days > 0) {
                    ...
                    <div class="row g-0">
                            ...
                            <div class="property-thumbnail">
                                <a href="<?=$baseurl;?>business/<?=$ad->slug;?>" class="property-img">
                                    <div class="property-overflow">
                                        <img src="<?=$baseurl.$picture;?>" alt="" class="img-fluid">
                                    </div>
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="detail">
                                ...
                                <!--    <li>-->
                                <!--        <button class="btn btn-success">Show Number </button>-->
                                <!--    </li>-->
                ...
                <?php } }else{ echo "<h4>No listing found</h4>"; } ?>
