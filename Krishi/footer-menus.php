    ...
    extract($_POST);
        ...
        if($error == ''){
            ...
            $arr['slug']=$slug;
                  ...
                  $addcity = "insert into footer (page,slug) values(:page,:slug)";
                  $stm = $con->prepare($addcity);
                  if($stm->execute($arr)){
                      echo "<script>
                                  window.location = 'footer-menus';</script>";
                  }
        }
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?=$p->page;?></td>
                    <td>
                      <a href="delete?id=<?=$p->id;?>&type=Footermenu" class="badge badge-danger" onclick="return confirm('Do you want to delete?');">Delete</a>
                    </td>
                  </tr>
                  <?php $sno++; endforeach; ?>
                  </tbody>
